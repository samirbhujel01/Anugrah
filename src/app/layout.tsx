              ...
              <nav className="w-full mt-4">
                <ul className="flex flex-wrap justify-center gap-2 md:gap-6 text-base font-medium items-center">
                  <li>
                    <a
                      href="/about"
                      className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50 bg-transparent"
                    >
