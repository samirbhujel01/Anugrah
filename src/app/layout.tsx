  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${dark ? "dark" : ""}`}>
      <body className="antialiased bg-background text-foreground dark:text-white transition-colors duration-300">
        <SessionProvider>
          {/* Responsive Navbar */}
          <header className="w-full bg-[hsl(40,80%,95%)] dark:bg-black/80 border-b border-blue-100 dark:border-[#222b3a] shadow-md backdrop-blur-md backdrop-saturate-150 py-4">
            <div className="flex flex-col items-center justify-center max-w-6xl mx-auto">
              ...
              <span className="mt-2 font-mono font-bold text-2xl sm:text-3xl text-blue-900 dark:text-blue-50 drop-shadow-sm text-center">
                {/* Always show the full text after typing animation */}
              ...
              <nav className="w-full mt-4">
                <ul className="flex flex-wrap justify-center gap-2 md:gap-6 text-base font-medium items-center">
                  <li>
                    <a href="/about" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <a href="/services" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <a href="/events" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <a href="/resources" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <a href="/media" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <a href="/announcements" className="flex items-center justify-center px-2 py-2 rounded-full hover:bg-blue-50 dark:hover:bg-[#222b3a] transition font-semibold text-blue-900 dark:text-blue-50">
                  ...
                  <li>
                    <button
                      ...
                      onClick={() => setDark((d) => !d)}
                      className="ml-2 px-3 py-2 rounded-full border border-blue-200 dark:border-[#222b3a] bg-blue-50 dark:bg-[#181f2e] text-blue-900 dark:text-blue-50 hover:bg-blue-100 dark:hover:bg-[#222b3a] transition flex items-center justify-center"
                      type="button"
                    >
